...
export function AboutPanel() {
    return (
        <div
            className="flex flex-col gap-4 px-4 py-4 text-sm"
        ...
        >
            <div>
                ...
                <p style={{ color: 'var(--scheme-fg-secondary)' }}>
                    A shared markdown note-taking app built with Laravel,
                    Inertia, and React.
                </p>
            </div>
            ...
            <div>
                ...
                >
                    <li>
                        ...
                        <kbd className="rounded border px-1">K</kbd> — Search
                    </li>
                    <li>
                        <kbd className="rounded border px-1">Ctrl</kbd> +{' '}
                        <kbd className="rounded border px-1">S</kbd> — Force
                        save
                    </li>
                </ul>
            </div>
